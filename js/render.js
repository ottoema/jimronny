...
function renderAuthBar() {
  ...
  if (!authToken) {
    bar.innerHTML = `
      ...
      <span style="font-size:14px;color:rgba(26,23,20,0.4)">Logga in för att synka med Google Sheets</span>`;
  } else {
    ...
    bar.innerHTML = `
      ...
      <button class="btn" onclick="loadFromSheets()" style="padding:4px 12px;font-size:14px;color:rgba(26,23,20,0.55)">↻ Hämta</button>
